...
import 'package:parallax_travel_cards_list/main.dart';
import 'package:parallax_travel_cards_list/models/city_data.dart';
import 'package:parallax_travel_cards_list/shared/rotation_3d.dart';
...
class CityScenery extends StatelessWidget {
  ...
  Widget _buildBackgroundTransition(Animation<double> animation) {
    ...
    var gradientEnd = ColorTween(begin: city.color, end: Color(0xFFfdf8f1))
        .evaluate(animation);
  ...
  Widget _buildCityAndTreesTransition(
      Animation<double> animation, Size screenSize) {
...
class _Leaf extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var dxPosition = Tween<double>(begin: -10, end: screenSize.width + 10)
        .transform(
            Interval(0, .9, curve: this.curve).transform(animationValue));
    var dyPosition =
        Tween<double>(begin: 0, end: pi * 2).transform(animationValue);
    var rotation = Tween<double>(begin: 0, end: 360)
