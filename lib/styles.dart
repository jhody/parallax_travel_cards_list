...
class Styles {
  ...
  static final TextStyle baseTitle =
      TextStyle(fontFamily: 'DMSerifDisplay', package: App.pkg);
  static final TextStyle baseBody =
      TextStyle(fontFamily: 'OpenSans', package: App.pkg);

  static final TextStyle appHeader =
      baseTitle.copyWith(color: Color(0xFF0e0e0e), fontSize: 24, height: 1.2);
  ...
  static final TextStyle cardSubtitle =
      baseBody.copyWith(color: Color(0xFF666666), height: 1.4, fontSize: 12);
  ...
  static final TextStyle hotelScore =
      baseBody.copyWith(color: Color(0xff0e0e0e), fontSize: 11);
  static final TextStyle hotelData =
      baseBody.copyWith(color: Colors.grey[700], fontSize: 11);

  static final TextStyle detailsTitleSection = baseBody.copyWith(
      color: Colors.black, fontSize: 14, fontWeight: FontWeight.bold);
  static final TextStyle detailsCardTitle =
      baseBody.copyWith(color: Colors.black, fontSize: 10, letterSpacing: 0.5);
}
